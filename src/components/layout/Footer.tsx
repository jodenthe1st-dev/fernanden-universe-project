...
export function Footer() {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { NewsletterSubscriptionsService } = await import("@/integrations/supabase/services/newsletterSubscriptions");
      await NewsletterSubscriptionsService.subscribe(newsletterEmail, undefined, "footer");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12">
          ...
          >
            <Link to="/" className="inline-block mb-8 group">
              <img
                src={settings.logo_url || logoMain}
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-serif text-2xl font-bold text-white mb-3">
                  {settings.site_name.toLowerCase()}
                </h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        <a href={`tel:${settings.contact_phone.replace(/\s/g, '')}`} className="text-soft-gray hover:text-white transition-colors body-regular block">
                  ...
                  <div className="flex items-start gap-4 group">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${settings.contact_email}`} className="text-soft-gray hover:text-white transition-colors body-regular">
