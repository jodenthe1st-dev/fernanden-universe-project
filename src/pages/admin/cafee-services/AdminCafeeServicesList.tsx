// src/pages/admin/cafee-services/AdminCafeeServicesList.tsx
...
export default function AdminCafeeServicesList() {
  ...
  useEffect(() => {
    ...
    if (searchParams.get('action') === 'new') {
      navigate('/admin/cafee-services/new');
    }
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Gérez vos services d'éducation et formation
          </p>
        </div>
        
        <Button onClick={() => navigate('/admin/cafee-services/new')}>
      ...
      {filteredServices.length === 0 ? (
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              {searchTerm ? 'Essayez une autre recherche' : 'Commencez par ajouter votre premier service CafEE'}
            </p>
          </CardContent>
        </Card>
      ) : (
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex gap-2">
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => navigate(`/admin/cafee-services/${service.id}`)}
                    className="flex-1"
                  >
                  ...
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => navigate(`/admin/cafee-services/${service.id}/edit`)}
                    className="flex-1"
                  >
                    <Edit className="h-4 w-4 mr-1" />
                    Modifier
