// src/pages/admin/she-services/AdminSHEServiceForm.tsx
...
export default function AdminSHEServiceForm() {
    ...
    try {
      for (let i = 0; i < files.length; i++) {
        ...
        if (file.type.startsWith('image/')) {
          const result = await CloudinaryService.uploadImage(file, 'she-services');
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center mb-8">
        <Button 
          variant="outline" 
          onClick={() => navigate('/admin/she-services')}
          className="mr-4"
        >
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
            {window.location.pathname.includes('/edit') ? 'Modifier' : 'Nouveau'} Service SHE
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            {window.location.pathname.includes('/edit') ? 'Modifiez les informations' : 'Ajoutez un nouveau service d\'événements et décoration'}
          </p>
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Ex: Organisation d'événements"
                      required
                    />
                  </div>
