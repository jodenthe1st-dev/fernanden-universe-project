// src/pages/admin/she-services/AdminSHEServiceView.tsx
...
export default function AdminSHEServiceView() {
  ...
  useEffect(() => {
    const loadService = async () => {
      try {
        const services = await DatabaseService.getServices('she');
